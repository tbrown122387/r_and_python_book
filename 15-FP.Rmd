...
"Don't repeat yourself" (DRY) is an idea that's been around for a while and is widely accepted [@hunt2000pragmatic]. DRY is the opposite of [WET\index{WET}](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself#WET\index{WET}).
:::
