...
Recall the `car.data` data set [@misc_car_evaluation_19]. 
...
import numpy as np
import pandas as pd
dataset1 = pd.DataFrame({'dog':['Charlie','Gus', 'Stubby', 'Toni','Pearl'],
                        'nickname':['Charles','Gus The Bus',np.nan,'Toni Bologna','Porl']})
dataset2 = pd.DataFrame({'dog':['Charlie','Gus', 'Toni','Arya','Shelby'],
