...
Notice that the assignment operator is different in Python\index{assignment operator!assignment operator in Python}. It's an `=`^[You can use this symbol in R, too, but it is less common.].
