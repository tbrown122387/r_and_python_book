...
Assignments are written with automatic grading in mind. R scripts are graded with the `gradeR` package [@gradeR], and Python scripts with the [`Otter-Grader` library](https://otter-grader.readthedocs.io/en/latest/). The quickest way to create your own autograding bundles is to use the tool here (TODO).
