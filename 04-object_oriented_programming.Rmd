...
S4 was developed after S3 in TODO. If you look at your search path (type `search()`), you will see `package:methods`. That's where all the code you need to do S4 is.
