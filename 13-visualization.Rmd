...
```{python, collapse = TRUE, fig.cap = "Another Simple Histogram", out.width='80%'}
...
```{python, collapse = TRUE, out.width='80%', fig.cap = "Side-By-Side Line Plots in Matplotlib"}
...
```{python, collapse = TRUE, out.width='80%', fig.cap = "Adjusted Closing Prices for a Stock Price Index" }
import pandas as pd
...
```{python, collapse = TRUE, out.width='80%', fig.cap = "Three Ways to Get the Same Histogram"}
...
```{python, collapse = TRUE, out.width='80%', fig.cap = "Lag Plot of Stock Index Returns"}
