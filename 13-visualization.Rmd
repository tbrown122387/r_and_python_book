...
```{r, collapse = TRUE, out.width='80%', fig.cap = "A Blank Canvas", fig.align='center'}
library(ggplot2)
...
```{r, collapse = TRUE, fig.cap = "A Second Scatterplot", fig.align='center', out.width='80%'}
library(ggplot2)
ggplot(mpg, aes(x = displ, y = hwy))  +
  geom_point()
```
...
```{r, collapse = TRUE, fig.cap = "Adding Some Color", fig.align='center', out.width='80%'}
...
```{r, collapse = TRUE, fig.cap = "Changing Scales", fig.align='center', out.width='80%'}
...
```{r, collapse = TRUE, fig.cap = "Changing the Fill Again", fig.align='center', out.width='80%'}
mpg$score <- 1/(mpg$displ^2 + mpg$hwy^2) 
ggplot(mpg, aes(x = displ, y = hwy, fill = score ))  +
  geom_tile() + 
...
```{python, collapse = TRUE, fig.cap = "Another Simple Histogram", out.width='80%', fig.align='center'}
