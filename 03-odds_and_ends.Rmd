...
1. if you receive new data, and you need to add it to a data frame, 
2. you recombine data sets (e.g. recombine a train/test split), or 
3 some linear algebra routines. 
...
`rbind` also works with `matrix` objects.
...
Sometimes we want to stack one data set on top of another. For instance, if we have a multvariate time series, and later on we receive another piece of information, we might need to do this. 
