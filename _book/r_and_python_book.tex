...
\DocumentationTok{\#\#  [1] {-}1.0880219  1.5829645 {-}0.7269905 {-}0.6667472  1.5122169 {-}0.1465768 {-}0.6481614 {-}0.2132982  0.7794293  1.6753766}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}2.69778113,  0.11592843, {-}0.79135341])}
\end{Highlighting}
\end{Shaded}
...
\item
  functions \emph{cannot} use \emph{global} variables defined in the environment where the function was \emph{called} in, and
\item
...
Last, consider another function factory example. \texttt{b} is destroyed after \texttt{factory()} finishes being called, but the function it creates still has a copy of \texttt{b} to use.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{def}\NormalTok{ factory():}
\NormalTok{  b }\OperatorTok{=} \StringTok{"I will live on, forever!"}
  \KeywordTok{def}\NormalTok{ func():}
    \ControlFlowTok{return}\NormalTok{ b}
  \ControlFlowTok{return}\NormalTok{ func}
\NormalTok{my\_func }\OperatorTok{=}\NormalTok{ factory()}
\NormalTok{my\_func()}
\CommentTok{\#\# \textquotesingle{}I will live on, forever!\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 140657858671968 140657858672000}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{typeOfDay}
\DocumentationTok{\#\#  [1] ({-}Inf,0] ({-}Inf,0] (0, Inf] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] (0, Inf] ({-}Inf,0] (0, Inf] ({-}Inf,0]}
...
\CommentTok{\#\# [\textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}]}
...
\CommentTok{\#\# array([{-}0.65709595,  0.71895782,  0.53708208,  1.11710087,  0.28240261,}
\CommentTok{\#\#        {-}0.16124072, {-}1.29462968,  0.37077191, {-}1.06060561, {-}0.09100567])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}2.54187257,  0.27798116,  0.13102643, {-}0.62643596, {-}1.77343478,}
\CommentTok{\#\#         0.52584417,  0.24314197,  0.56691169, {-}1.90160784, {-}1.08602576])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.53760769,  1.31102614, {-}1.01599654, {-}1.54940669,  0.60171093,}
\CommentTok{\#\#        {-}0.23955959,  1.33782836,  1.16356082,  0.24199987,  0.55964144])}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-133-1} \caption{Visualizing Our Three Functions}\label{fig:unnamed-chunk-133}
\end{figure}
...
\DocumentationTok{\#\# [1] {-}1.6117528  0.9248115  1.1956147  0.4721976  0.7182541}
\FunctionTok{sort}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] {-}1.6117528  0.4721976  0.7182541  0.9248115  1.1956147}
\FunctionTok{order}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] 1 4 5 2 3}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# [ 1.56928375  0.29236016 {-}0.23577027  1.91857423 {-}1.44419334]}
\NormalTok{np.sort(silly\_data)}
\CommentTok{\#\# array([{-}1.44419334, {-}0.23577027,  0.29236016,  1.56928375,  1.91857423])}
\NormalTok{np.argsort(silly\_data)}
\CommentTok{\#\# array([4, 2, 1, 0, 3])}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-160}A Simple Histogram}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-161}Some Scatterplots}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-162-1} \caption{A Blank Canvas}\label{fig:unnamed-chunk-162}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-163}A Second Scatterplot}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-165}Adding Some Color}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-166}Changing Scales}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-167}Changing the Fill}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-168}Changing the Fill Again}
\end{figure}
...
\CommentTok{\#\# (array([  3.,  21.,  55., 148., 231., 270., 174.,  76.,  19.,   3.]), array([{-}3.3522234 , {-}2.68363382, {-}2.01504423, {-}1.34645465, {-}0.67786506,}
\CommentTok{\#\#        {-}0.00927548,  0.65931411,  1.32790369,  1.99649328,  2.66508286,}
\CommentTok{\#\#         3.33367245]), \textless{}a list of 10 Patch objects\textgreater{})}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-html/unnamed-chunk-2-1}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7fed3e531a20\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7fed3e531da0\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7fed3e53a160\textgreater{}]}
...
\CommentTok{\#\# \textless{}matplotlib.legend.Legend object at 0x7fed3e325128\textgreater{}}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7fed3e53a748\textgreater{}]}
\NormalTok{myAxes[}\DecValTok{1}\NormalTok{].legend()}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=18.67in]{r_and_python_book_files/figure-html/unnamed-chunk-2-3}

\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-html/unnamed-chunk-2-5} \caption{Side-By-Side Line Plots in Matplotlib}\label{fig:unnamed-chunk-173}
\end{figure}
...
\includegraphics[width=18.67in]{r_and_python_book_files/figure-html/unnamed-chunk-2-1}
...
\DocumentationTok{\#\# {-}0.186626600 {-}0.001734603  0.505918900 {-}0.260795610  0.288033685 {-}0.112180365}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}1.6315 {-}0.7279  0.4213  0.5854  1.4320 }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)   0.3371     0.3224   1.046    0.323}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Residual standard error: 1.019 on 9 degrees of freedom}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1] {-}0.093699495  0.054415420 {-}0.118230613  0.076560924  0.140967268  0.073739736 {-}0.030871158  0.091842600}
\DocumentationTok{\#\#  [9] {-}0.187439259  0.007772341}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## [1] -2.588782e-03  1.000185e+02 -1.000051e+02
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## [1] -0.008091561 -0.008037002 -0.010109641
## 
## [[2]]
## [1]  99.99497 100.00403
## 
## [[3]]
## [1] -99.98601
\end{verbatim}
...
\includegraphics[width=0.7\linewidth]{r_and_python_book_files/figure-html/unnamed-chunk-2-1}
