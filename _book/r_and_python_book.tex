...
\DocumentationTok{\#\#  [1]  0.76201099 {-}0.25613370  0.04902923 {-}0.72442548  0.52838621  0.23930254 {-}0.99305508  0.73942551}
\DocumentationTok{\#\#  [9]  1.50493636 {-}0.26520080}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 0.22017332,  0.38051099, {-}0.98205728])}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{typeOfDay}
\DocumentationTok{\#\#  [1] (0, Inf] ({-}Inf,0] (0, Inf] (0, Inf] (0, Inf] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] (0, Inf] (0, Inf]}
...
\DocumentationTok{\#\# 1001     999.8168   {-}998.2064          1.4         0.2 SETOSA!            1}
\DocumentationTok{\#\# 1002     999.3307  {-}1000.5718          1.4         0.2 SETOSA!            1}
\DocumentationTok{\#\# 1003       4.7000   {-}999.0314          1.3         0.2 SETOSA!            1}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 149    998.251302  {-}997.811961           1.4          0.2  SETOSA!       1.0}
\CommentTok{\#\# 148    999.191612  {-}998.623510           1.4          0.2  SETOSA!       1.0}
\CommentTok{\#\# 147      4.700000 {-}1000.003527           1.3          0.2  SETOSA!       1.0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 149    998.251302  {-}997.811961           1.4  ...  SETOSA!      1.0             0}
\CommentTok{\#\# 148    999.191612  {-}998.623510           1.4  ...  SETOSA!      1.0             1}
\CommentTok{\#\# 147      4.700000 {-}1000.003527           1.3  ...  SETOSA!      1.0             2}
\CommentTok{\#\# }
...
\CommentTok{\#\# array([ 0.55477724,  0.41413355,  0.96085134,  0.1407009 , {-}0.47968853,}
\CommentTok{\#\#        {-}1.22610964, {-}1.23971318,  1.57319349,  1.48325094,  0.28352799])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.43911781,  0.26582995,  1.0565605 , {-}0.88607198, {-}0.03710272,}
\CommentTok{\#\#         0.37917265,  0.20273979, {-}0.139861  , {-}0.91155849,  0.72214628])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 1.16799018,  0.27867374, {-}0.07853349, {-}0.26096722,  0.06495153,}
\CommentTok{\#\#         1.32838682,  0.47719804, {-}0.96904138,  0.78508845,  0.81323274])}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-140-1} \caption{Visualizing Our Three Functions}\label{fig:unnamed-chunk-140}
\end{figure}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-143-1.pdf}
...
\DocumentationTok{\#\# [1] {-}1.069159  1.597054 {-}1.103327  0.596831 {-}1.207086}
\FunctionTok{sort}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] {-}1.207086 {-}1.103327 {-}1.069159  0.596831  1.597054}
\FunctionTok{order}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] 5 3 1 4 2}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# [ 1.00326035  1.33570318  1.13763402 {-}1.29912552  0.74210305]}
\NormalTok{np.sort(silly\_data)}
\CommentTok{\#\# array([{-}1.29912552,  0.74210305,  1.00326035,  1.13763402,  1.33570318])}
\NormalTok{np.argsort(silly\_data)}
\CommentTok{\#\# array([3, 4, 0, 2, 1])}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-167}A Simple Histogram}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-168}Some Scatterplots}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-169-1} \caption{A Blank Canvas}\label{fig:unnamed-chunk-169}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-170}A Second Scatterplot}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-172}Adding Some Color}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-173}Changing Scales}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-174}Changing the Fill}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-175-1.pdf}
\caption{\label{fig:unnamed-chunk-175}Changing the Fill Again}
\end{figure}
...
\CommentTok{\#\# (array([  4.,  24.,  97., 189., 227., 220., 153.,  66.,  17.,   3.]), array([{-}3.04637573, {-}2.4199116 , {-}1.79344748, {-}1.16698336, {-}0.54051924,}
\CommentTok{\#\#         0.08594489,  0.71240901,  1.33887313,  1.96533725,  2.59180138,}
\CommentTok{\#\#         3.2182655 ]), \textless{}a list of 10 Patch objects\textgreater{})}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-178-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-179-3.pdf}

\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-180-5} \caption{Side-By-Side Line Plots in Matplotlib}\label{fig:unnamed-chunk-180}
\end{figure}
...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-194-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-207-1.pdf}
...
\DocumentationTok{\#\#  0.20459645  0.07652842  0.56611007  0.12396402 {-}0.47183324 {-}0.14797574}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}2.1875 {-}0.8623  0.5223  0.7790  1.6196 }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)   0.4956     0.4014   1.235    0.248}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Residual standard error: 1.269 on 9 degrees of freedom}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1]  0.0160339412 {-}0.0786430531  0.0004604979 {-}0.1351301905  0.1509747881  0.1905770962  0.1108207936}
\DocumentationTok{\#\#  [8] {-}0.1186822605 {-}0.0329771221 {-}0.0869986459}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## [1]   -0.01354974   99.99540987 -100.00283908
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## [1]  0.008918389  0.010288593 -0.011230676
## 
## [[2]]
## [1] 100.01665  99.99541
## 
## [[3]]
## [1] -100.0188
\end{verbatim}
...
\includegraphics[width=0.7\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-227-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-243-1.pdf}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-245-1.pdf}
