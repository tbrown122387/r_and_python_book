...
\CommentTok{\#\# 140493631759712 140493631759744}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1] ".GlobalEnv"         "package:R6"         "package:Matrix"     "package:ggplot2"   }
\DocumentationTok{\#\#  [5] "package:reticulate" "tools:rstudio"      "package:stats"      "package:graphics"  }
\DocumentationTok{\#\#  [9] "package:grDevices"  "package:utils"      "package:datasets"   "package:methods"   }
\DocumentationTok{\#\# [13] "Autoloads"          "package:base"}
\end{Highlighting}
\end{Shaded}
...
R comes with some built-in functions \texttt{plot()}, \texttt{hist()}, \texttt{boxplot()}, etc. Many of these reside in \texttt{package:graphics}, which comes pre-loaded into the search path. \texttt{plot()} on the other hand, is higher up the search path in \texttt{package:base}--it is a generic method whose methods can reside in many places (e.g.~in \texttt{package:graphics} or some place else).
...
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-227-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-228-3.pdf}

\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-229-5} \caption{Side-By-Side Line Plots in Matplotlib}\label{fig:unnamed-chunk-229}
\end{figure}
...
mention that you don't discuss Pandas plotting even though it's quite conveneint.
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-256-1.pdf}
...
\DocumentationTok{\#\#  [1]  0.18971263 {-}0.07595286  0.18400138  0.08895979 {-}0.08496412  0.06865526  0.08697484 {-}0.09550573}
\DocumentationTok{\#\#  [9]  0.01071571  0.02142769}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-273-1.pdf}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-274-1.pdf}
...
\includegraphics[width=0.7\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-276-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-290-1.pdf}
