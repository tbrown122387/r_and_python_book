...
\DocumentationTok{\#\#  [1]  1.0761374 {-}0.7508032 {-}0.4899507  1.2474798  1.0251222  1.2043709 {-}0.5320196  1.1423383 {-}0.4611399}
\DocumentationTok{\#\# [10] {-}1.5301810}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.811128  ,  0.2257682 , {-}0.91921848])}
\end{Highlighting}
\end{Shaded}
...
\chapter{\texorpdfstring{R's \texttt{list}s Versus Python's \texttt{list}s and Dictionaries}{R's lists Versus Python's lists and Dictionaries}}\label{rs-lists-versus-pythons-lists-and-dictionaries}}
...
\CommentTok{\#\# 140328445875552 140328445875584}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{typeOfDay}
\DocumentationTok{\#\#  [1] (0, Inf] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] (0, Inf] ({-}Inf,0] (0, Inf] (0, Inf] ({-}Inf,0] (0, Inf]}
...
\CommentTok{\#\# [\textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}]}
...
\CommentTok{\#\# array([{-}0.5126524 ,  0.1566794 ,  1.51515309, {-}0.6087987 , {-}0.8186656 ,}
\CommentTok{\#\#         2.01670806, {-}0.19679004,  1.04240121,  0.8930571 , {-}1.25850883])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.08912259,  0.12166268,  1.33552168,  1.21217794,  0.51807594,}
\CommentTok{\#\#         0.81217249, {-}1.40578026, {-}0.08473983,  0.6202171 , {-}0.44714262])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 1.04228361, {-}0.74492593, {-}1.1317017 , {-}1.96032149, {-}0.09316334,}
\CommentTok{\#\#        {-}2.12767854, {-}0.67546808,  0.31398889,  1.30694523,  0.36415567])}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-131-1} \caption{Visualizing Our Three Functions}\label{fig:unnamed-chunk-131}
\end{figure}
...
\DocumentationTok{\#\# [1] {-}0.03708202 {-}1.17545709 {-}1.34363020  0.38723512  0.37705838}
\FunctionTok{sort}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] {-}1.34363020 {-}1.17545709 {-}0.03708202  0.37705838  0.38723512}
\FunctionTok{order}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] 3 2 1 5 4}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# [ 0.16281438 {-}0.07993891 {-}0.23360895 {-}0.92996242 {-}2.95138317]}
\NormalTok{np.sort(silly\_data)}
\CommentTok{\#\# array([{-}2.95138317, {-}0.92996242, {-}0.23360895, {-}0.07993891,  0.16281438])}
\NormalTok{np.argsort(silly\_data)}
\CommentTok{\#\# array([4, 3, 2, 1, 0])}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-158}A Simple Histogram}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-159}Some Scatterplots}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-160-1} \caption{A Blank Canvas}\label{fig:unnamed-chunk-160}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-161}A Second Scatterplot}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-163}Adding Some Color}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-164}Changing Scales}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-165}Changing the Fill}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-166}Changing the Fill Again}
\end{figure}
...
\CommentTok{\#\# (array([  9.,  29.,  74., 145., 226., 242., 162.,  84.,  22.,   7.]), array([{-}3.04592189, {-}2.43083116, {-}1.81574042, {-}1.20064968, {-}0.58555894,}
\CommentTok{\#\#         0.02953179,  0.64462253,  1.25971327,  1.87480401,  2.48989475,}
\CommentTok{\#\#         3.10498548]), \textless{}a list of 10 Patch objects\textgreater{})}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-171-5} \caption{Side-By-Side Line Plots in Matplotlib}\label{fig:unnamed-chunk-171}
\end{figure}
...
\DocumentationTok{\#\# {-}0.36304669 {-}0.06248811 {-}0.33902043 {-}0.53348058  0.30111467  0.30365474}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}1.2604 {-}0.5851 {-}0.2481  0.5817  1.9651 }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)  {-}0.2438     0.3160  {-}0.772     0.46}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Residual standard error: 0.9991 on 9 degrees of freedom}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1]  0.001794624 {-}0.040589323 {-}0.017031484 {-}0.051361857  0.067512812  0.086231731  0.011460005}
\DocumentationTok{\#\#  [8] {-}0.034333536  0.079393586 {-}0.043010070}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## [1]   0.00585364  99.99083049 -99.99913674
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## [1]  0.007092268  0.002768089 -0.005602510
## 
## [[2]]
## [1] 100.00981  99.98752
## 
## [[3]]
## [1] -99.98798
\end{verbatim}
