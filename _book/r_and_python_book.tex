...
\DocumentationTok{\#\#  [1]  1.8114892 {-}0.2285257  0.3278625 {-}1.4643152 {-}1.1424843 {-}1.2750914 {-}0.9460275  2.1206117 {-}0.6472018  2.2693876}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([0.19446118, 0.38206327, 0.36005756])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 139983403640160 139983403640192}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
This chapter describes some considerations to make when you are dealing with categorical data in your program. While statisticians may describe data as being categorical or numerical. This classification is different than classifying data by its type in a program.
...
\NormalTok{typeOfDay}
\DocumentationTok{\#\#  [1] (0, Inf] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] (0, Inf] ({-}Inf,0] ({-}Inf,0] (0, Inf] ({-}Inf,0]}
...
\CommentTok{\#\# [\textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}]}
...
\CommentTok{\#\# array([{-}1.47803874, {-}0.85572478, {-}1.26961174, {-}2.30975761,  0.23769402,}
\CommentTok{\#\#        {-}0.10741396, {-}1.33626672,  0.01988994,  0.10557012, {-}1.31208947])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.73262775,  0.71107741, {-}0.10460775,  1.48406727,  0.22563566,}
\CommentTok{\#\#        {-}0.33232372, {-}1.5457928 ,  0.47928525,  0.3689327 , {-}1.33724625])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.7044891 , {-}0.67439848,  0.39321771, {-}0.84409836,  1.66342908,}
\CommentTok{\#\#         0.2890751 ,  0.94534194,  1.64246026,  0.33217141,  1.1547187 ])}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# [1]  0.35626592 {-}0.48234364 {-}0.41232139  0.07701254 {-}0.21067599}
\FunctionTok{sort}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] {-}0.48234364 {-}0.41232139 {-}0.21067599  0.07701254  0.35626592}
\FunctionTok{order}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] 2 3 5 4 1}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# [{-}0.92455362  0.29703176  0.02218716 {-}1.24130758  0.74340305]}
\NormalTok{np.sort(silly\_data)}
\CommentTok{\#\# array([{-}1.24130758, {-}0.92455362,  0.02218716,  0.29703176,  0.74340305])}
\NormalTok{np.argsort(silly\_data)}
\CommentTok{\#\# array([3, 0, 2, 1, 4])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# (array([  3.,  14.,  42., 105., 190., 261., 182., 122.,  64.,  17.]), array([{-}3.39158746, {-}2.78322939, {-}2.17487132, {-}1.56651326, {-}0.95815519,}
\CommentTok{\#\#        {-}0.34979713,  0.25856094,  0.86691901,  1.47527707,  2.08363514,}
\CommentTok{\#\#         2.69199321]), \textless{}a list of 10 Patch objects\textgreater{})}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f508046cef0\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f50804772b0\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f503acb3128\textgreater{}]}
...
\CommentTok{\#\# \textless{}matplotlib.legend.Legend object at 0x7f50398795f8\textgreater{}}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f5080477780\textgreater{}]}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-html/unnamed-chunk-1-5} \caption{Side-By-Side Line Plots in Matplotlib}\label{fig:unnamed-chunk-171}
\end{figure}
...
\DocumentationTok{\#\# 0.18791379 0.32860530 0.37409096 0.06753335 0.21127377 0.08396739}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}2.4850 {-}0.4852  0.2328  0.6394  1.4447 }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)   0.2834     0.3587    0.79     0.45}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Residual standard error: 1.134 on 9 degrees of freedom}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1]  0.05552465  0.10719996  0.03776452 {-}0.00606762  0.15164697  0.02808534  0.06334364  0.02870436  0.10133659}
\DocumentationTok{\#\# [10] {-}0.08658825}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## [1]   -0.00276107   99.99417045 -100.00156871
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## [1]  0.009768508 -0.001187353 -0.018654894
## 
## [[2]]
## [1] 100.0103 100.0027
## 
