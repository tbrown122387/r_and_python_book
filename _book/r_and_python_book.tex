...
\CommentTok{\#\# array([{-}0.60722846, {-}0.73013497, {-}0.22706565])}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-69-1} 

}

\caption{An Indicator Function}\label{fig:unnamed-chunk-69}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-70-1} 

}

\caption{The Marginal Density of Y}\label{fig:unnamed-chunk-70}
\end{figure}
...
\CommentTok{\#\# 139815570920800 139815570920832}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
The Pandas library in Python has data frames that are modeled after R's \citep{pandas_guy}.\index{data frame!data frames in Python}
...
\CommentTok{\#\# 149    999.266237  {-}996.657617          0.2  SETOSA!       1.0}
\CommentTok{\#\# 148    997.754535  {-}999.644772          0.2  SETOSA!       1.0}
\CommentTok{\#\# 147      4.700000  {-}998.888384          0.2  SETOSA!       1.0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 149  {-}996.657617          0.2  SETOSA!       1.0             0}
\CommentTok{\#\# 148  {-}999.644772          0.2  SETOSA!       1.0             1}
\CommentTok{\#\# 147  {-}998.888384          0.2  SETOSA!       1.0             2}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 0.7212574 , {-}0.99120654, {-}0.06727749, {-}1.01739191])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 0.96185404, {-}0.47949807, {-}0.74075652, {-}0.35814739])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}1.06710333, {-}0.83851323,  0.74953555, {-}0.5886097 ])}
\end{Highlighting}
\end{Shaded}
...
\href{https://ggplot2.tidyverse.org/index.html}{\texttt{ggplot2}} is a popular third-party visualization package for R.\index{ggplot2} There are also libraries in Python (e.g.~\href{https://plotnine.readthedocs.io/en/stable/\#}{\texttt{plotnine}}) that have a similar look and feel. This subsection provides a short tutorial on how to use \texttt{ggplot2} in R, and it is primarily based off of the material provided in \citep{ggplot2}. Other excellent descriptions of \texttt{ggplot2} are \citep{r_in_action} and \citep{r_graphics_cookbook}.
...
Matplotlib \citep{Hunter:2007} is a third-party visualization library in Python.\index{Matplotlib} It is the oldest and most heavily-used, so it is the best way to start making graphics in Python, in my humble opinion. It also comes installed with Anaconda.
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2959ff7278\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2959ff7390\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2959ff76d8\textgreater{}]}
...
\CommentTok{\#\# \textless{}matplotlib.legend.Legend object at 0x7f295a087080\textgreater{}}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2959ff7ef0\textgreater{}]}
\NormalTok{myAxes[}\DecValTok{1}\NormalTok{].legend()}
\CommentTok{\#\# \textless{}matplotlib.legend.Legend object at 0x7f295a018080\textgreater{}}
\NormalTok{plt.show()}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# \textless{}matplotlib.axes.\_subplots.AxesSubplot object at 0x7f2959fe10b8\textgreater{}}
\end{Highlighting}
\end{Shaded}
