...
\hypertarget{part-part-i-introducing-the-basics}{%
\part{Part I: Introducing the Basics}\label{part-part-i-introducing-the-basics}}
...
\DocumentationTok{\#\#  [1] {-}1.5063775  1.4968354 {-}1.1056687 {-}1.9291411  1.5537725 {-}0.4094657 {-}0.6147064 {-}1.1860563 {-}0.9917598 {-}1.1227121}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.71840108, {-}2.12832683,  0.11888053])}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Consider this \href{https://archive.ics.uci.edu/ml/datasets/Wine+Quality}{wine data set} from \citep{wine_data} hosted by \citep{uci_data}. Read it in with the following code
\end{enumerate}
...
\DocumentationTok{\#\#  [1] "coefficients"  "residuals"     "effects"       "rank"          "fitted.values" "assign"        "qr"           }
\DocumentationTok{\#\#  [8] "df.residual"   "contrasts"     "xlevels"       "call"          "terms"         "model"}
...
\CommentTok{\#\# 139804936668512 139804936668544}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{typeOfDay}
\DocumentationTok{\#\#  [1] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] (0, Inf] (0, Inf] (0, Inf] ({-}Inf,0]}
...
\CommentTok{\#\# [\textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}, \textquotesingle{}bad day\textquotesingle{}, \textquotesingle{}good day\textquotesingle{}]}
...
\begin{verbatim}
bash: /home/taylor/.local/share/r-miniconda/envs/r-reticulate/lib/libtinfo.so.6: no version information available (required by bash)
6 0 66  50  1
6 1 70  50  2
6 0 69  50  3
6 0 68  50  4
...
\DocumentationTok{\#\#  [1] ".GlobalEnv"         "package:R6"         "package:Matrix"     "package:Hmisc"      "package:ggplot2"   }
\DocumentationTok{\#\#  [6] "package:Formula"    "package:survival"   "package:lattice"    "package:reticulate" "tools:rstudio"     }
\DocumentationTok{\#\# [11] "package:stats"      "package:graphics"   "package:grDevices"  "package:utils"      "package:datasets"  }
\DocumentationTok{\#\# [16] "package:methods"    "Autoloads"          "package:base"}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 0.16414334, {-}0.74455512,  0.49301558, {-}0.50023817, {-}0.37603616,}
\CommentTok{\#\#         1.15600828, {-}1.13372645,  0.08708511, {-}0.57919206,  0.07535512])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 0.03313485, {-}0.49799463,  0.94741964, {-}0.99649894, {-}0.49847179,}
\CommentTok{\#\#        {-}0.15574502, {-}0.24355157, {-}0.52742125, {-}1.66586655, {-}0.60842579])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.68062288,  0.49780581, {-}0.36762053,  1.42783586,  0.85699947,}
\CommentTok{\#\#         0.60822757, {-}0.63609282, {-}0.08496536,  0.33526155, {-}1.95280616])}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-133-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-136-1.pdf}
...
\DocumentationTok{\#\# [1] {-}1.2288807 {-}0.7139817 {-}0.2849920  3.0825927 {-}0.8289408}
\FunctionTok{sort}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] {-}1.2288807 {-}0.8289408 {-}0.7139817 {-}0.2849920  3.0825927}
\FunctionTok{order}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] 1 5 2 3 4}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# [{-}0.41702768  1.05660063 {-}0.36279931 {-}1.33374099 {-}0.35111098]}
\NormalTok{np.sort(silly\_data)}
\CommentTok{\#\# array([{-}1.33374099, {-}0.41702768, {-}0.36279931, {-}0.35111098,  1.05660063])}
\NormalTok{np.argsort(silly\_data)}
\CommentTok{\#\# array([3, 0, 2, 4, 1])}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-162-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-168-1.pdf}
...
\CommentTok{\#\# (array([  1.,   2.,  20.,  75., 204., 287., 241., 126.,  33.,  11.]), array([{-}4.37621771, {-}3.60411374, {-}2.83200976, {-}2.05990578, {-}1.28780181,}
\CommentTok{\#\#        {-}0.51569783,  0.25640614,  1.02851012,  1.8006141 ,  2.57271807,}
\CommentTok{\#\#         3.34482205]), \textless{}a list of 10 Patch objects\textgreater{})}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-html/unnamed-chunk-1-1}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f26afcb95c0\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f26afcb9940\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f26afcb9cc0\textgreater{}]}
...
\CommentTok{\#\# \textless{}matplotlib.legend.Legend object at 0x7f26b0024c88\textgreater{}}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f26afc7e2e8\textgreater{}]}
\NormalTok{myAxes[}\DecValTok{1}\NormalTok{].legend()}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=18.67in]{r_and_python_book_files/figure-html/unnamed-chunk-1-3}

\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-html/unnamed-chunk-1-5}
...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-186-1}
...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-187-1}
...
\includegraphics[width=18.67in]{r_and_python_book_files/figure-html/unnamed-chunk-1-1}
...
\DocumentationTok{\#\#  0.04069595  0.65169163  0.37011443  0.06416552 {-}0.28724117 {-}0.08979900}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}0.6055 {-}0.4588 {-}0.1620  0.2605  1.1357 }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)  {-}0.2648     0.1818  {-}1.456    0.179}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Residual standard error: 0.575 on 9 degrees of freedom}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1]  0.04093835  0.05719291  0.09578950 {-}0.04683210  0.01296983  0.20182524 {-}0.18335845 {-}0.05106115  0.08318709}
\DocumentationTok{\#\# [10]  0.19941884}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-218-1.pdf}
...
\includegraphics[width=0.7\linewidth]{r_and_python_book_files/figure-html/unnamed-chunk-1-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-238-1.pdf}
