...
Alternatively you may choose to store your data in a **serialized** form. With this approach, you are still saving your data in a more permanent way to your hard drive, but it is stored in format that's usually more efficient. 
...
Below we write out `d` to a file called `oring_out2.csv`.
...
Here's how the first few rows of that file looks in a text editor.
...
Serialization is possible in Python, just like it is in R. In Python, it is sometimes called *pickling* an object. 

TODO compare size, pandas versus non pandas, pickle versus cpickle