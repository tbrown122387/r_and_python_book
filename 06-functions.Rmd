...
Thankfully, R functions are very similar to Python functions. In both languages, functions are **first-class objects** [@struc_and_interp]. This means that, no matter which of these two languages you are using, functions
...
These examples get at *functional programming*, which is discussed more in depth in chapter \@ref(functional-programming). If you are interested in learning more, read on. That chapter will describe strategies to make your code much easier to understand and maintain (e.g. keep your functions "pure"!)
