...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-67-1}
...
\CommentTok{\#\# 139684999988576 139684999988608}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
\caption{A Blank Canvas}\label{fig:unnamed-chunk-219}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-229-5} 

}

\caption{Adjusted Closing Prices for a Stock Price Index}\label{fig:unnamed-chunk-229}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-230-7} 

}

\caption{Three Ways to Get the Same Histogram}\label{fig:unnamed-chunk-230}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-231-9} 

}

\caption{Lag Plot of Stock Index Returns}\label{fig:unnamed-chunk-231}
\end{figure}
...
\caption{Monte Carlo: With and Without Common Random Numbers Part 2}\label{fig:unnamed-chunk-292}
\end{figure}
