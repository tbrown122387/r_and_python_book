...
\DocumentationTok{\#\#  [1]  0.61151649  0.63651137  1.28401356 {-}1.57033132  1.35815369 {-}1.04832253 {-}0.13612953  0.49850924  1.56714566  0.02049535}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.07197755,  0.73571468,  0.32495528])}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1] "coefficients"  "residuals"     "effects"       "rank"          "fitted.values" "assign"        "qr"            "df.residual"  }
\DocumentationTok{\#\#  [9] "contrasts"     "xlevels"       "call"          "terms"         "model"}
...
\CommentTok{\#\# 140505574221152 140505574221184}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{allSeasons }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"autumn"}\NormalTok{, }\StringTok{"summer"}\NormalTok{, }\StringTok{"spring"}\NormalTok{, }\StringTok{"winter"}\NormalTok{)}
...
\NormalTok{typeOfDay}
\DocumentationTok{\#\#  [1] ({-}Inf,0] (0, Inf] (0, Inf] ({-}Inf,0] ({-}Inf,0] ({-}Inf,0] (0, Inf] ({-}Inf,0] ({-}Inf,0] (0, Inf]}
...
\hypertarget{categorical-data-in-pandas-two-options}{%
\section{Categorical Data in Pandas: Two Options}\label{categorical-data-in-pandas-two-options}}
...
The second option is to use Pandas' \texttt{Categorical} containers. They are quite similar, so the choice is subtle. Like \texttt{Series} containers, they also have the same shared \texttt{dtype} for all of its elements.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all\_szns }\OperatorTok{=}\NormalTok{ [}\StringTok{"autumn"}\NormalTok{, }\StringTok{"summer"}\NormalTok{,}\StringTok{"spring"}\NormalTok{,}\StringTok{"winter"}\NormalTok{]}
...
Another option is to create the \texttt{dtype} before you create the \texttt{Series}.
...
Finally, columns of a Pandas \texttt{DataFrame} TODO
...
\DocumentationTok{\#\#  [1] ".GlobalEnv"         "package:R6"         "package:Matrix"     "package:Hmisc"      "package:ggplot2"    "package:Formula"   }
\DocumentationTok{\#\#  [7] "package:survival"   "package:lattice"    "package:reticulate" "tools:rstudio"      "package:stats"      "package:graphics"  }
\DocumentationTok{\#\# [13] "package:grDevices"  "package:utils"      "package:datasets"   "package:methods"    "Autoloads"          "package:base"}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.54898883, {-}0.04462729, {-}1.0060096 ,  0.54204847,  0.39121158,}
\CommentTok{\#\#         0.30111422,  3.36254324, {-}0.6993337 , {-}0.25509157,  0.32016321])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 0.63635758, {-}0.54391069, {-}2.19510254,  0.68768553, {-}0.34403857,}
\CommentTok{\#\#        {-}0.18730533, {-}0.147557  ,  1.62833261, {-}0.74286593,  0.55234974])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.71088378, {-}1.16089171,  1.34735938,  2.00316252,  2.21705117,}
\CommentTok{\#\#        {-}0.59863831,  0.23673286,  0.48312857, {-}0.80383867, {-}0.11358594])}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-135-1} \caption{Visualizing Our Three Functions}\label{fig:unnamed-chunk-135}
\end{figure}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-138-1.pdf}
...
\DocumentationTok{\#\# [1] {-}0.27463361 {-}1.56059313 {-}1.05094346  0.02973225  1.22297418}
\FunctionTok{sort}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] {-}1.56059313 {-}1.05094346 {-}0.27463361  0.02973225  1.22297418}
...
\CommentTok{\#\# [{-}0.21407534 {-}0.3257987  {-}0.14476762  0.44611069  1.75538806]}
\NormalTok{np.sort(silly\_data)}
\CommentTok{\#\# array([{-}0.3257987 , {-}0.21407534, {-}0.14476762,  0.44611069,  1.75538806])}
\NormalTok{np.argsort(silly\_data)}
\CommentTok{\#\# array([1, 0, 2, 3, 4])}
\end{Highlighting}
\end{Shaded}
...
\caption{\label{fig:unnamed-chunk-162}A Simple Histogram}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-163}Some Scatterplots}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-164-1} \caption{A Blank Canvas}\label{fig:unnamed-chunk-164}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-165}A Second Scatterplot}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-167}Adding Some Color}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-168}Changing Scales}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-169}Changing the Fill}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-170-1.pdf}
\caption{\label{fig:unnamed-chunk-170}Changing the Fill Again}
\end{figure}
...
\CommentTok{\#\# (array([  6.,  14.,  73., 170., 207., 235., 171.,  90.,  27.,   7.]), array([{-}3.22083403, {-}2.58939639, {-}1.95795875, {-}1.32652112, {-}0.69508348,}
\CommentTok{\#\#        {-}0.06364584,  0.5677918 ,  1.19922944,  1.83066707,  2.46210471,}
\CommentTok{\#\#         3.09354235]), \textless{}a list of 10 Patch objects\textgreater{})}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-173-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-174-3.pdf}

\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-175-5} \caption{Side-By-Side Line Plots in Matplotlib}\label{fig:unnamed-chunk-175}
\end{figure}
...
\begin{verbatim}
##  [1] plot,ANY-method                plot,color-method              plot.aareg*                    plot.acf*                     
##  [5] plot.agnes*                    plot.areg*                     plot.areg.boot*                plot.aregImpute*              
##  [9] plot.biVar*                    plot.clusGap*                  plot.cox.zph*                  plot.curveRep*                
## [13] plot.data.frame*               plot.decomposed.ts*            plot.default                   plot.dendrogram*              
## [17] plot.density*                  plot.describe*                 plot.diana*                    plot.drawPlot*                
## [21] plot.ecdf                      plot.factor*                   plot.formula*                  plot.function                 
## [25] plot.gbayes*                   plot.ggplot*                   plot.gtable*                   plot.hcl_palettes*            
## [29] plot.hclust*                   plot.histogram*                plot.HoltWinters*              plot.isoreg*                  
## [33] plot.lm*                       plot.medpolish*                plot.mlm*                      plot.mona*                    
## [37] plot.numpy.ndarray*            plot.partition*                plot.ppr*                      plot.prcomp*                  
## [41] plot.princomp*                 plot.profile.nls*              plot.Quantile2*                plot.R6*                      
## [45] plot.raster*                   plot.rm.boot*                  plot.rpart*                    plot.shingle*                 
## [49] plot.silhouette*               plot.spec*                     plot.spline*                   plot.stepfun                  
## [53] plot.stl*                      plot.summary.formula.response* plot.summary.formula.reverse*  plot.summaryM*                
## [57] plot.summaryP*                 plot.summaryS*                 plot.Surv*                     plot.survfit*                 
## [61] plot.table*                    plot.trans*                    plot.transcan*                 plot.trellis*                 
## [65] plot.ts                        plot.tskernel*                 plot.TukeyHSD*                 plot.varclus*                 
## [69] plot.xyVector*                
...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-188-1}
...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-189-1}
...
\DocumentationTok{\#\# {-}0.01871332 {-}0.02613900  0.26891386 {-}0.75332392 {-}0.17628879 {-}0.31707897}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}1.3585 {-}0.3423  0.2123  0.3425  0.6993 }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)  0.09403    0.19123   0.492    0.635}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Residual standard error: 0.6047 on 9 degrees of freedom}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1]  0.04793368 {-}0.10798621 {-}0.03842842 {-}0.10800547 {-}0.13585295  0.05067403  0.03361170  0.22796252  0.06839836 {-}0.10267969}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## [1]  -0.009895526 100.004831085 -99.996052368
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## [1]  0.01419771  0.01580794 -0.01009711
## 
## [[2]]
## [1]  99.99545 100.00675
## 
## [[3]]
## [1] -100.0009
\end{verbatim}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-219-1.pdf}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-220-1.pdf}
...
\includegraphics[width=0.7\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-222-1}
