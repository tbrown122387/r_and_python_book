...
\DocumentationTok{\#\#  [1] {-}1.39247900  1.55893931 {-}0.93508012 {-}0.75268248  1.15855912  0.05811579  0.14838622  2.37408155}
\DocumentationTok{\#\#  [9]  0.10155982 {-}0.14109475}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}1.96360267, {-}0.94363614,  0.5874203 ])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 140030859404640 140030859404672}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{typeOfDay}
\DocumentationTok{\#\#  [1] (0, Inf] ({-}Inf,0] (0, Inf] (0, Inf] (0, Inf] (0, Inf] (0, Inf] (0, Inf] ({-}Inf,0] (0, Inf]}
...
\DocumentationTok{\#\# 1001    1000.3550   {-}998.6721          1.4         0.2 SETOSA!            1}
\DocumentationTok{\#\# 1002     998.5078   {-}998.2051          1.4         0.2 SETOSA!            1}
\DocumentationTok{\#\# 1003       4.7000   {-}999.1970          1.3         0.2 SETOSA!            1}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 149   1000.184431 {-}1000.909619           1.4          0.2  SETOSA!       1.0}
\CommentTok{\#\# 148    998.034037  {-}998.010435           1.4          0.2  SETOSA!       1.0}
\CommentTok{\#\# 147      4.700000 {-}1000.591115           1.3          0.2  SETOSA!       1.0}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# 149   1000.184431 {-}1000.909619           1.4  ...  SETOSA!      1.0             0}
\CommentTok{\#\# 148    998.034037  {-}998.010435           1.4  ...  SETOSA!      1.0             1}
\CommentTok{\#\# 147      4.700000 {-}1000.591115           1.3  ...  SETOSA!      1.0             2}
\CommentTok{\#\# }
...
\item
  ...
  \item
    The formula for distance between \((\lambda_1, \phi_1)\) (longitude, latitude) and \((\lambda_2, \phi_2)\) is \[2 r \text{arcsin}\left( \sqrt{ \sin^2\left( \frac{\phi_2 - \phi_1}{2}\right)  + \cos(\phi_1)\cos(\phi_2) \sin^2\left( \frac{\lambda_2 - \lambda_1}{2} \right)  } \right)\]
  \end{itemize}
\item
...
\DocumentationTok{\#\# Warning in scan(file = file, what = what, sep = sep, quote = quote, dec = dec, : invalid input found on}
\DocumentationTok{\#\# input connection \textquotesingle{}data/Google.html\textquotesingle{}}
...
\CommentTok{\#\# array([ 0.3903846 ,  1.49037373, {-}0.53367429, {-}0.69780338, {-}0.83300751,}
\CommentTok{\#\#         1.23473929, {-}0.18847469, {-}0.67168727, {-}0.79759138,  1.00143225])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([ 0.75666818,  0.32625064,  1.56399872, {-}0.0498167 ,  0.46542052,}
\CommentTok{\#\#        {-}0.71971939,  0.188614  , {-}1.2013905 ,  1.02809876, {-}1.03846279])}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# array([{-}0.86257198,  0.18361224, {-}0.58225819, {-}0.11312519,  1.01730026,}
\CommentTok{\#\#        {-}0.30001308, {-}0.46650025, {-}0.43145147,  1.32517553,  0.92800806])}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-163-1} \caption{Visualizing Our Three Functions}\label{fig:unnamed-chunk-163}
\end{figure}
...
\DocumentationTok{\#\# [1] 0.2608364 0.8079231 0.2730665 0.7111604 0.8343133}
\FunctionTok{sort}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] 0.2608364 0.2730665 0.7111604 0.8079231 0.8343133}
\FunctionTok{order}\NormalTok{(sillyData)}
\DocumentationTok{\#\# [1] 1 3 4 2 5}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# [{-}1.29968816  1.25096144 {-}0.65654745  0.6620695  {-}2.05821782]}
\NormalTok{np.sort(silly\_data)}
\CommentTok{\#\# array([{-}2.05821782, {-}1.29968816, {-}0.65654745,  0.6620695 ,  1.25096144])}
\NormalTok{np.argsort(silly\_data)}
\CommentTok{\#\# array([4, 0, 2, 3, 1])}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-190-1.pdf}
\caption{\label{fig:unnamed-chunk-190}A Simple Histogram}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-191-1.pdf}
\caption{\label{fig:unnamed-chunk-191}Some Scatterplots}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-192-1} \caption{A Blank Canvas}\label{fig:unnamed-chunk-192}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-193-1.pdf}
\caption{\label{fig:unnamed-chunk-193}A Second Scatterplot}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-195-1.pdf}
\caption{\label{fig:unnamed-chunk-195}Adding Some Color}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-196}Changing Scales}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-197}Changing the Fill}
\end{figure}
...
\caption{\label{fig:unnamed-chunk-198}Changing the Fill Again}
\end{figure}
...
\CommentTok{\#\# (array([ 14.,  53.,  94., 186., 253., 213., 108.,  52.,  21.,   6.]), array([{-}2.73304126, {-}2.14239593, {-}1.5517506 , {-}0.96110528, {-}0.37045995,}
\CommentTok{\#\#         0.22018538,  0.8108307 ,  1.40147603,  1.99212136,  2.58276668,}
\CommentTok{\#\#         3.17341201]), \textless{}a list of 10 Patch objects\textgreater{})}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-201-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-202-3.pdf}

\begin{figure}
\includegraphics[width=0.8\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-203-5} \caption{Side-By-Side Line Plots in Matplotlib}\label{fig:unnamed-chunk-203}
\end{figure}
...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-216-1}
...
\includegraphics[width=0.5\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-217-1}
...
\DocumentationTok{\#\# {-}0.03262945  0.14236781 {-}0.18926881  0.58655198  0.45605050 {-}0.35285085}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}1.5391 {-}1.1539  0.2991  0.9796  1.4831 }
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Coefficients:}
\DocumentationTok{\#\#             Estimate Std. Error t value Pr(\textgreater{}|t|)}
\DocumentationTok{\#\# (Intercept)   0.1240     0.3599   0.345    0.738}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Residual standard error: 1.138 on 9 degrees of freedom}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  [1]  0.05866348  0.08061422 {-}0.27164499 {-}0.03317958 {-}0.22574769 {-}0.09322182  0.04080655  0.15535097}
\DocumentationTok{\#\#  [9] {-}0.01201120  0.01452213}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## [1] -1.574064e-03  9.999153e+01 -1.000090e+02
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## [1] -0.003189279  0.001770459 -0.003361573
## 
## [[2]]
## [1] 100.0051 100.0015
## 
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-247-1.pdf}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-248-1.pdf}
...
\includegraphics[width=0.7\linewidth]{r_and_python_book_files/figure-latex/unnamed-chunk-250-1}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-266-1.pdf}
...
\includegraphics{r_and_python_book_files/figure-latex/unnamed-chunk-268-1.pdf}
