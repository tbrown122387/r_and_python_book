...
\CommentTok{\#\# 139828223583584 139828223583616}
\BuiltInTok{print}\NormalTok{(a)}
\CommentTok{\#\# 1}
\end{Highlighting}
\end{Shaded}
...
In R, this can be done with \texttt{rbind()} (short for ``row bind''). Consider the following example that makes use of GIS data queried from \citep{albemarle_county_gis_web}.
...
Recall our Albemarle Real Estate data set \citep{albemarle_county_gis_web}.
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2c400c6390\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2c400c64a8\textgreater{}]}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2c400c67f0\textgreater{}]}
...
\CommentTok{\#\# \textless{}matplotlib.legend.Legend object at 0x7f2c400ada58\textgreater{}}
...
\CommentTok{\#\# [\textless{}matplotlib.lines.Line2D object at 0x7f2c400cc048\textgreater{}]}
\NormalTok{myAxes[}\DecValTok{1}\NormalTok{].legend()}
\CommentTok{\#\# \textless{}matplotlib.legend.Legend object at 0x7f2c400cce48\textgreater{}}
\NormalTok{plt.show()}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\# \textless{}matplotlib.axes.\_subplots.AxesSubplot object at 0x7f2c400d6c50\textgreater{}}
\end{Highlighting}
\end{Shaded}
