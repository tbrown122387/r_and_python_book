...
"NaN" abbreviates "not a number." `NaN` is an object of type `double` in R, and `np.nan` is of type `float` in Python. It can come in handy when you (delibrately or accidentally) perform undefined calculations such as $0/0$ or $\infty / -\infty$.
